...
from gnss.model import JaGuard


class LightningJaGuard(pl.LightningModule):
    ...
    def configure_optimizers(self):
        return torch.optim.Adam(
            ...
            weight_decay=self.hparams.weight_decay_val
        )
...
def train_lightning_model(
    ...
    metadata, config, num_total_sats
):
    ...
    return trainer, checkpoint_callback.best_model_path, trainer.callback_metrics